...
In iteration #3, I built a dynamic and visually engaging portfolio site using GSAP (GreenSock Animation Platform) and Three.js. This was my first experience with both libraries, and I learned a great deal in the process.
