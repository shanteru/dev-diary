...
Here's a polished description for your portfolio site:

In this project, I built a dynamic and visually engaging portfolio site using GSAP (GreenSock Animation Platform) and Three.js. This was my first experience with both libraries, and I learned a great deal in the process.
...
## Iteration #4 : Minimalist blog concept

### Current Portfolio Project: Minimalist Blog Concept

In my latest iteration, I focused on a minimalist blog concept that allows for seamless integration of YouTube videos. This approach reflects my preference for clean, straightforward designs that represent my personal style.
